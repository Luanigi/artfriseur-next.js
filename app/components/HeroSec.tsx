  ...
  return (
    <div className="herotxt text-center">
      <div className="header-con">
        <h1 className="text-[130px] pt-14 pr-5 hero-header">
          ART
        </h1>
      </div>

      <p className="italic text-[20px] z-10 text-white uppercase tracking-wide">Entdecke dein neues Ich ~ Dein Style beginnt hier!</p>
